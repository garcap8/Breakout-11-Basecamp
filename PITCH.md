...
Next: Build the tone-safety gate for the abusive-message case (R8KD3F) before Build 4, and decide whether fare_rules earns its 411 tokens/turn -- nobody has run a question that picks it yet.
